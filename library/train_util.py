...
class BaseDataset(torch.utils.data.Dataset):
    ...
    def process_caption(self, subset: BaseSubset, caption, return_info: bool = False):
        ...
        if is_drop_out:
            ...
            caption_mode = getattr(subset, "caption_mode", "caption")
            if isinstance(caption, dict) and caption_mode == "mixed":
        ...
        return all(
            [
                not (
                    ...
                    or getattr(subset, "caption_mode", "caption") == "mixed"
...
class DreamBoothDataset(BaseDataset):
    ...
    def __init__(
        ...
        def load_dreambooth_dir(subset: DreamBoothSubset):
            ...
            subset_caption_mode = getattr(subset, "caption_mode", "caption")
            if subset_caption_mode == "mixed" and use_cached_info_for_subset:
                logger.warning(
